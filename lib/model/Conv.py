...
class MultiConv(nn.Module):
    def __init__(self, filter_channels, is_transpose = False, kernel_size = 2, stride = 2):
        ...
        if not is_transpose:
            for l in range(0, len(filter_channels) - 1):
                self.filters.append(
                    nn.Conv2d(filter_channels[l], filter_channels[l + 1], kernel_size=kernel_size, stride=stride))
            ...
            for l in range(0, len(filter_channels) - 1):
                self.filters.append(
                    nn.ConvTranspose2d(filter_channels[l], filter_channels[l + 1], kernel_size=kernel_size, stride=stride))
