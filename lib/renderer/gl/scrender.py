...
class scRender(CamRender):
    def __init__(self, width:int=1600, height:int=1200, name:string='PRT Renderer', uv_mode:bool=False, ms_rate=1, egl=False):
        program_files = ['sc.vs', 'sc.fs']
        ...
        ### sc
        self.sc_setAlbedo=True
        self.sc_setNormal=True
    ...
    def set_mesh(self, vertices, faces, norms, faces_nml, uvs, faces_uvs, tans, bitans, mat_name='all'):
